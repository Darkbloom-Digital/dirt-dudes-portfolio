        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Professional land clearing services in Cleveland, TN. Transforming properties with expertise and dedication.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center text-gray-400">
                ...
                <a href="tel:+1234567890" className="hover:text-red-500 transition-colors duration-200">
                  (123) 456-7890
                </a>
              </li>
              <li className="flex items-center text-gray-400">
                ...
                <a href="mailto:info@tndirtpros.com" className="hover:text-red-500 transition-colors duration-200">
                  info@tndirtpros.com
                </a>
              </li>
              <li className="flex items-center text-gray-400">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} TN Dirt Pros. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link href="/privacy-policy" className="text-gray-400 text-sm hover:text-red-500 transition-colors duration-200">
                Privacy Policy
              </Link>
              <Link href="/terms-of-service" className="text-gray-400 text-sm hover:text-red-500 transition-colors duration-200">
                Terms of Service
              </Link>
            </div>
          </div>
