...
export default function LandGradingPage() {
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="relative min-h-0 py-6 sm:py-10 pt-36 sm:pt-28 flex items-start justify-center bg-gradient-to-b from-black to-neutral-900 px-2 sm:px-4">
        ...
        <div className="text-center z-10">
          ...
          >
            <span className="text-red-600">LAND</span> GRADING
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Professional land grading for proper drainage and site preparation
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 items-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2 sm:mb-4">Expert Land Grading Services</h2>
              <p className="text-gray-300 mb-2 sm:mb-4">
                Ensure your property is level, stable, and ready for construction or landscaping.
              </p>
      ...
      <section className="py-12 bg-gradient-to-b from-black to-neutral-900">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center">
          ...
          >
            Contact us today for a free grading assessment and quote. We&apos;ll ensure your land is ready for your next project.
          </motion.p>
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
