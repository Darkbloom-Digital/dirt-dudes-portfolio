    ...
    <main className="min-h-screen bg-black">
      ...
      <section className="relative h-[60vh] flex items-center justify-center bg-gradient-to-b from-black to-neutral-900">
        ...
        <div className="text-center z-10">
          ...
          >
            Comprehensive excavation services for any project size, from residential to commercial
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold text-white mb-6">Professional Excavation Solutions</h2>
              <p className="text-gray-300 mb-6">
                From small residential jobs to large commercial projects, we have the equipment and expertise 
                to handle any excavation need. Our team ensures precise, safe, and efficient excavation services.
              </p>
